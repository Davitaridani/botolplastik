...
<main class="wrapper">
  ...
  {{-- Section Breadcump --}}
  <section class="section-detail-1" id="breadcump">
    <div class="container">
      <div class="inner">
        <div class="d-flex flex-column">
          <nav
            class="border-top border-bottom py-3 d-flex justify-content-between text-blue-dark fs-13 fw-medium mb-60">
            <ol class="breadcrumb mb-0">
              ...
              <li class="breadcrumb-item"><a href="{{ url('products') }}"
                  class="text-reset text-decoration-none">Koleksi Botol Plastik</a></li>
            ...
            <a href="{{ url('products') }}" class="text-reset text-decoration-none"><span
                class="me-3">&#10094;</span>Kembali Ke
  ...
  {{-- End Section Breadcump --}}

  {{-- Section Detail Products --}}
  <section class="section-detail-2" id="detail-produk">
    <div class="container">
          ...
          <div class="w-784">
            ...
            <ul class="list-group list-group-flush mb-30">
              ...
              <li class="list-group-item py-4">
                ...
                <p class="fs-19 mb-0">Praesent tincidunt, orci sed mattis malesuada, neque turpis sagittis orci, nec
                  maximus
                  diam arcu quis libero. Duis molestie consequat urna, eget varius leo fringilla eget. Praesent
                  pellentesque
  ...
  {{-- End Section Detail Products --}}

  {{-- Section Detail Products --}}
  <section class="section-detail-3" id="product-lainnya">
    <div class="container">
      <div class="inner mb-100">
        <div class="d-flex flex-column">
          <div class="py-3 border-top border-bottom d-flex justify-content-between mb-60">
            ...
            <a href="{{ url('products') }}" class="fw-medium text-decoration-none"><span
                class="me-3">&#10094;</span>Kembali
            ...
            <div class="row px-md-3 mx-1 row-cols-2 row-cols-lg-4 g-2 g-lg-5 ">
              @for ($i = 4, $total = count($produk); $i < $total; $i++) <div class="col">
                <div class="card bg-white border-0 mb-4 mb-md-0">
                  <img src="{{ url($produk[$i]['image']) }}" class="card-img-top" loading="lazy" alt="...">
                  <div class="card-body text-center">
                    <h6 class="card-title text-primary fw-bold py-24 fs-18">{{ $produk[$i]["name"] }}</h6>
                    <a href="{{ url('products/details', ['id' => $i]) }}" class="btn btn-primary  fw-bold fs-15">Lihat
                      Produk</a>
                  </div>
                </div>
            </div>

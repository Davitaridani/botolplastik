      ...
      <section class="text-center mb-100">
        ...
        <ul class="list-group list-group-flush mb-30">
          ...
          <li class="list-group-item py-4">
            ...
            <p class="fs-19 mb-0">Praesent tincidunt, orci sed mattis malesuada, neque turpis sagittis orci, nec maximus diam arcu quis libero. Duis molestie consequat urna, eget varius leo fringilla eget. Praesent pellentesque metus sed posuere aliquet. Nullam scelerisque erat a metus viverra commodo.</p>
          </li>
          <li class="list-group-item py-4">
      ...
      <section class="mb-100">
        ...
        <div class="px-md-5">
          <div class="row px-md-3 mx-1 row-cols-2 row-cols-lg-4 g-2 g-lg-5 ">
            @for ($i = 4, $total = count($produk); $i < $total; $i++)
            <div class="col">

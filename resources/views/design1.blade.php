...
<main id="main" class="wrapper">
        ...
        <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
          <div class="carousel-indicators d-flex justify-content-start">
            <div class="indicator-item d-none d-xl-block">
              @for ($i = 0; $i < 4; $i++) <button type="button" data-bs-target="#carouselExampleIndicators"
                data-bs-slide-to="{{ $i }}" class="{{ $i == 0 ? 'active' : '' }}" aria-label="Slide {{ $i }}"></button>
                @endfor
            </div>
          </div>
              ...
              <div class="container card-img-overlay d-flex align-items-center px-0 mx-105 mt-5 pt-2 pt-lg-5">
                <div class="row d-none d-md-block mt-1 mt-sm-3 pt-2 mx-0">
                  <div class="col-md-8 col-lg-6 pe-5">
                    ...
                    <button class="btn bg-blue-light border-0 mt-50 rounded-pill fw-bold px-4 text-white">Lihat Koleksi
                      <i class="fas fa-chevron-right ms-4"></i></button>
                  </div>
                </div>
              </div>
          </div>
  ...
  {{-- end section --}}
  <section class="home-sec-2" id="tentang-botolplastik">
    <div class="container">
      <div class="inner">
        <div class="mb-40 mt-150">
        ...
        <article>
          ...
          <p class="w-75 text-center px-3 mb-40 mx-auto">Botolplastik.id adalah divisi trading yang menjual aneka produk
            ...
            industri rumah tangga, hingga industri besar sekalipun. Dengan pengalaman lebih dari 3 dekade dibidang
            plastik,
            ...
            pengalaman dan pengetahuan unik dari para pendiri kami, kami adalah mitra terbaik dan paling menguntungkan
            Anda
  ...
  {{-- end section --}}
  <section class="home-sec-3" id="produk-aplikasi">
    <div class="container">
      <div class="inner">
        <div class="pt-5 pb-5">
        ...
        <div class="container-fluid pb-5">
          <div class="row mx-0 row-cols-2 row-cols-md-3 row-cols-lg-6 g-2 g-lg-5" id="produkAplikasi">
            ...
            <div
              class="col text-center {{ $item == end($aplikasi) ? '' : 'border-end' }} fw-bold text-blue-dark pt-5 fs-15">
  ...
  {{-- end section --}}
  <section class="home-sec-4" id="best-sellers">
    <div class="container">
      <div class="inner">
        <div class="px-0">
  ...
  {{-- end section --}}
  <section class="home-sec-4" id="new-items">
    <div class="container">
      <div class="inner">
        <div class="px-0">
  ...
  {{-- end section --}}
  <section class="home-sec-5" id="see-more">
    <div class="container">
      <div class="inner">
        <div class="px-0">
  ...
  {{-- end section --}}
  <section class="home-sec-6" id="see-more-category">
    <div class="container">
      <div class="inner">
        <div class="px-0 py-5">
          ...
          <div class="border-top border-bottom py-3">
            <div class="d-md-flex justify-content-center text-center fw-bold container px-4 pt-2 mt-1 fs-15">
              ...
              <p class="border-4 px-3 {{ $item == end($kategori) ? '' : 'border-end-blue-dark'  }}"><a
                  href="{{ $item['link'] }}" class="text-decoration-none link-hover-lainnya text-blue-dark">{{ $item['name']
                  }}</a></p>
              @endforeach
            </div>
          </div>
